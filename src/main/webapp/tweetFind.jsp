          ...
          if (status.equals("completed")){
            ...
            if(TwitterUtil.isSuccessfulDetection(jobResult)){
              ...
              try{
                ...
                String bestUUIDMatch = null;
                bestUUIDMatch = TwitterUtil.getUUIDOfBestMatchFromIdentificationJSONResults(jobResult);
                ...
                // } catch(Exception e){
                //   // e.printStackTrace();
                //   System.out.println("getUUIDOfBestMatchFromIdentificationJSONResults failed");
                // }
